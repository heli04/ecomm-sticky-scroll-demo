...
.reveal-section  .reveal-section__container .reveal-section__content {
  flex: 1;
}

.reveal-section  .reveal-section__container .reveal-section__title {
  font-size: 20px;
  margin-bottom: 16px;
  color: rgb(64,64,64);
  font-family: madefor-text-mediumbold,helveticaneuew01-45ligh,helveticaneuew02-45ligh,helveticaneuew10-45ligh,sans-serif;
...
.reveal-section  .reveal-section__container .reveal-section__description {
  font-size: 16px;
  line-height: 1.8rem;
  color: rgb(0,0,0);
  font-family: madefor-text-mediumbold,helveticaneuew01-45ligh,helveticaneuew02-45ligh,helveticaneuew10-45ligh,sans-serif;
...
.reveal-section  .reveal-section__container .reveal-section__list {
  padding-left: 20px;
  margin-top: 15px;
  list-style: disc;
  font-family: madefor-text-mediumbold,helveticaneuew01-45ligh,helveticaneuew02-45ligh,helveticaneuew10-45ligh,sans-serif;
...
.reveal-section  .reveal-section__container .reveal-section__list-item {
  margin-bottom: 15px;
  font-family: madefor-text-mediumbold,helveticaneuew01-45ligh,helveticaneuew02-45ligh,helveticaneuew10-45ligh,sans-serif;
}

.reveal-section  .reveal-section__container .reveal-section__bold {
  font-weight: bold;
}

.reveal-section  .reveal-section__container .reveal-section__image {
  flex: 1;
  height: 320px;
  min-height: 320px; 
